...
export default function VoiceConversationPage() {
  ...
  return (
    <div className="page-container max-w-3xl flex flex-col h-[100vh] py-4 overflow-hidden relative fade-in">
      ...
      {/* Control Area */}
      <div className="shrink-0 pt-4 pb-2 flex flex-col items-center">
        <button
          onClick={toggleRecording}
          disabled={isAiThinking}
          className={`w-15 h-15 rounded-full flex items-center justify-center transition-all duration-300 shadow-xl disabled:opacity-50 disabled:cursor-not-allowed ${isRecording
